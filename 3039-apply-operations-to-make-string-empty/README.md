<h2><a href="https://leetcode.com/problems/apply-operations-to-make-string-empty/">3039. Apply Operations to Make String Empty</a></h2><h3>Medium</h3><hr><p>You are given a string <code>s</code>.</p>
